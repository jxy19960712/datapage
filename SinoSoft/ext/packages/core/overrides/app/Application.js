...
Ext.application = function(config) {
    var createApp = function (SinoSoft) {
            // This won't be called until SinoSoft class has been created.
            Ext.onReady(function() {
                var Viewport = Ext.viewport;
                Viewport = Viewport && Viewport['Viewport'];
                if (Viewport && Viewport.setup) {
                    Viewport.setup(SinoSoft.prototype.config.viewport);
                }
                Ext.app.Application.instance = new SinoSoft();
            });
        };
