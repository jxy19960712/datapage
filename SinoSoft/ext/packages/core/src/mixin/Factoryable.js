 ...
 *      var obj;
 *
 *      obj = SinoSoft.bar.Thing.create('thing'); // same as "new SinoSoft.bar.Thing()"
 *
 *      obj = SinoSoft.bar.Thing.create({
 *          type: 'thing'       // same as above
 *      });
 *
 *      obj = SinoSoft.bar.Thing.create({
 *          xclass: 'SinoSoft.bar.Thing'  // same as above
 *      });
 *
 *      var obj2 = SinoSoft.bar.Thing.create(obj);
