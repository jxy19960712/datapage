Ext.define('SinoSoft.view.util.imagechoosebydiv.item', {
    ...
    initComponent: function () {
        ...
        var me = this;
        me.setStyle({
            backgroundImage: 'url(' + (me.src || me.emptyImgUrl) + ')'
        });
        if (!(me.readOnly || me.disabled)) {
            ...
            me.filefield.on('afterrender', function (btn) {
                btn.fileInputEl.dom.setAttribute('accept', 'image/*');
            });
