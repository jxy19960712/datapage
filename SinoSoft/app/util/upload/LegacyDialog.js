 ...
 * 
 *      @example
 *      var dialog = Ext.create('SinoSoft.util.upload.Dialog', {
 ...
 * 
 */
Ext.define('SinoSoft.util.upload.LegacyDialog', {
    ...
    initComponent : function() {
        ...
        this.uploadManager = Ext.create('SinoSoft.util.upload.Manager', {
            url : this.uploadUrl,
