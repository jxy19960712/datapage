 ...
 * 
 * @class SinoSoft.util.upload.ItemGridPanel
 * @extends Ext.grid.Panel
 */
Ext.define('SinoSoft.util.upload.ItemGridPanel', {
    extend : 'Ext.grid.Panel',

    requires : [
        'Ext.selection.CheckboxModel', 'SinoSoft.util.upload.Store'
    ],
    ...
    initComponent : function() {
        ...
        Ext.apply(this, {
            store : Ext.create('SinoSoft.util.upload.Store'),
