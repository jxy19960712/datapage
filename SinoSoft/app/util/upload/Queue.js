 ...
 * 
 */
Ext.define('SinoSoft.util.upload.Queue', {
    extend : 'Ext.util.MixedCollection',

    requires : [
        'SinoSoft.util.upload.Item'
    ],
     ...
     * 
     * @return {SinoSoft.util.upload.Item[]}
     */
    getItems : function() {
     ...
     * 
     * @return {SinoSoft.util.upload.Item/null}
     */
     ...
     * 
     * @param {SinoSoft.util.upload.Item[]} items
     */
    ...
    createItem : function(file) {
        ...
        var item = Ext.create('SinoSoft.util.upload.Item', {
            fileApiObject : file
        });
