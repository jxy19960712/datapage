 ...
 * 
 */
Ext.define('SinoSoft.util.upload.uploader.LegacyExtJsUploader', {
    extend: 'SinoSoft.util.upload.uploader.AbstractUploader',

    requires : [
        'SinoSoft.util.upload.data.Connection'
    ],
     ...
     * 
     * @return {SinoSoft.util.upload.data.Connection}
     */
    initConnection : function() {
        ...
        var conn = Ext.create('SinoSoft.util.upload.data.Connection', {
            disableCaching : true,
            method : this.method,
            url : url,
    ...
    /**
     * Implements {@link SinoSoft.util.upload.uploader.AbstractUploader#uploadItem}
     * 
     * @param {SinoSoft.util.upload.Item} item
     */
    ...
    /**
     * Implements {@link SinoSoft.util.upload.uploader.AbstractUploader#abortUpload}
     */
