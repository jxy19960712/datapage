 ...
 * 
 */
Ext.define('SinoSoft.util.upload.uploader.ExtJsUploader', {
    extend: 'SinoSoft.util.upload.uploader.AbstractXhrUploader',
    ...
    initConnection : function() {
        ...
        if (this.connection instanceof Ext.data.Connection) {
            ...
            conn = Ext.create('SinoSoft.util.upload.data.Connection', {
                disableCaching : true,
                method : this.method,
                url : url,
