 ...
 * 
 *     @example
 *     var formDataUploader = Ext.create('SinoSoft.util.upload.uploader.FormDataUploader', {
 *         url: '/api/upload'
 *     });
 *     
 *     var uploadPanel = Ext.create('SinoSoft.util.upload.Panel', {
 ...
 * 
 */
Ext.define('SinoSoft.util.upload.Panel', {
    extend : 'Ext.panel.Panel',

    requires : [
        'SinoSoft.util.upload.ItemGridPanel',
        'SinoSoft.util.upload.Manager',
        'SinoSoft.util.upload.StatusBar',
        'SinoSoft.util.upload.BrowseButton',
        'SinoSoft.util.upload.Queue'
    ],
    ...
    config : {
         ...
         * uploader object, for example if the {@link SinoSoft.util.upload.uploader.ExtJsUploader} is used, the params are sent
         * as GET params.
         */
        uploadParams : {},
    ...
    /**
     * @property {SinoSoft.util.upload.Queue}
     * @private
     */
    queue : null,

    /**
     * @property {SinoSoft.util.upload.ItemGridPanel}
     * @private
     */
    grid : null,

    /**
     * @property {SinoSoft.util.upload.Manager}
     * @private
     */
    uploadManager : null,

    /**
     * @property {SinoSoft.util.upload.StatusBar}
     * @private
     */
    statusBar : null,

    /**
     * @property {SinoSoft.util.upload.BrowseButton}
     * @private
     */
    browseButton : null,
    ...
    initComponent : function() {
        ...
        this.grid = Ext.create('SinoSoft.util.upload.ItemGridPanel', {
            queue : this.queue,
        ...
        this.statusBar = Ext.create('SinoSoft.util.upload.StatusBar', {
            dock : 'bottom',
    ...
    createUploadManager : function() {
        ...
        var uploadManager = Ext.create('SinoSoft.util.upload.Manager', {
    ...
    getTopToolbarConfig : function() {
        ...
        this.browseButton = Ext.create('SinoSoft.util.upload.BrowseButton', {
     ...
     * 
     * @return {SinoSoft.util.upload.Queue}
     */
    initQueue : function() {
        var queue = Ext.create('SinoSoft.util.upload.Queue');
     ...
     * new files.
     * 
     * @param {SinoSoft.util.upload.BrowseButton} input
     ...
     * 
     * @param {SinoSoft.util.upload.Queue} queue
     */
