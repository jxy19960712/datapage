 ...
 * 
 */
Ext.define('SinoSoft.util.upload.Manager', {
    mixins : {
        observable : 'Ext.util.Observable'
    },

    requires : [
        'SinoSoft.util.upload.uploader.AbstractUploader'
    ],
    ...
    DEFAULT_UPLOADER_CLASS: 'SinoSoft.util.upload.uploader.ExtJsUploader',
    ...
    constructor : function(config) {
        ...
        if (!(this.uploader instanceof SinoSoft.util.upload.uploader.AbstractUploader)) {
