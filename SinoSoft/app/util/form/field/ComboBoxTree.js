Ext.define('SinoSoft.util.form.field.ComboBoxTree', {
    ...
    alternateClassName: 'SinoSoft.util.form.field.ComboBoxTree',
    ...
    mixins: [
            ...
            if (picker && me.autoSelect && store.getCount() > 0) {
                if (me.autoSelectLast) {
                    ...
                    if (value) {
                        ...
                        path.reverse();
                        //console.log(path);
                        picker.expandPath(path.join('/'));
                        if (!me.isEqual(lastSelected, value)) {
                            picker.setSelection(value);
                        }
                        picker.view.scrollRowIntoView(value);
                    } else {
        ...
        onSelectionChange: function (tree, records, eOpts) {
            ...
            if (record.data.leaf) {
                ...
                return this.fireEvent('selectionchange', this, records[0], eOpts);
            }
        },
