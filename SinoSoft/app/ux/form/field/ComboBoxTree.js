Ext.define('SinoSoft.ux.form.field.ComboBoxTree', {
    extend: 'Ext.form.field.Picker',
    requires: [
        'Ext.util.DelayedTask',
        'SinoSoft.ux.ajaxtree.View',
        'Ext.data.StoreManager',
    ],
    alternateClassName: 'SinoSoft.view.form.field.ComboBoxTree',
    ...
    fields: [
        { name: 'id', mapping: 'aaa' },
        { name: 'text', mapping: 'bbb' },
        { name: 'leaf', mapping: 'ddd' },
        { name: 'children', mapping: 'children' },
        { name: 'icon', mapping: 'icon' },
        { name: 'expanded', mapping: 'ccc', efaultValue: false },
    ...
    applyValueNotFoundText: function (v) {
        //console.log('applyValueNotFoundText');
        var me = this,
    ...
    onEndUpdateFilters: function (filters) {
        //console.log('onEndUpdateFilters');
        var me = this,
            was = me.filtered,
    ...
    checkValueOnChange: function () {
        //console.log('checkValueOnChange');
        var me = this;
    ...
    doAutoSelect: function () {
        ...
        if (picker && me.autoSelect && store.getCount() > 0) {
            if (me.autoSelectLast) {
                ...
                if (value && value != null) {
                    value = Ext.isObject(value) ? value : me.findRecordByValue(value);
                    //console.log(value);
                    if (!me.isEqual(lastSelected, value)) {
    ...
    doTypeAhead: function (doTypeAhead) {
        //console.log('afterRender');
        var me = this;
    ...
    createPicker: function () {
        ...
        if (!store.isEmptyStore) {
            Ext.apply(pickerCfg, { store: store });
        }
    ...
    getPickerStore: function () {
        //console.log('getPickerStore');
        return this.picker?this.picker.store:this.store;
    },
    onFocusLeave: function (e) {
        if (this.picker ? (!this.picker.isdoajax) : true) {
            this.collapse();
        }
        
    },
    onBeforePickerShow: function (picker) {
        //console.log('onBeforePickerShow');
    ...
    onSelectionChange: function (sel, records, eOpts) {
        //console.log('onSelectionChange');
        var record = records[0] || records;
        if (!sel.view.ownerCt.isdoajax) {
            this.setValue(record);
            return this.fireEvent('selectionchange', this, record, eOpts);
        }
        //if (record.isLeaf()) {
    ...
    getSelection: function () {
        ...
        return selection.length == 0 ? lastSelection : selection;
    },
    ...
    updateBindSelection: function (selModel, selection) {
        //console.log('updateBindSelection');
        var me = this,
            selected = null;
    ...
    isSelectionUpdating: function () {
        //console.log('isSelectionUpdating');
    ...
    findRecordByValue: function (value) {
        //console.log('findRecordByValue');
        var me = this;
        var result = null;
        var store = this.getPickerStore();
        store.getRoot().cascade(function (node) {
            if (node.data[me.valueField] == value) {
                result = node;
            }
        });
        return result;
    ...
    findRecordByDisplay: function (value) {
        //console.log('findRecordByDisplay');
    ...
    getRecordDisplayData: function (record) {
        //console.log('getRecordDisplayData');
        return record.data;
    },
