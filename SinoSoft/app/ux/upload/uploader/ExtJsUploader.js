 ...
 * 
 */
Ext.define('SinoSoft.ux.upload.uploader.ExtJsUploader', {
    extend: 'SinoSoft.ux.upload.uploader.AbstractXhrUploader',
    ...
    initConnection : function() {
        ...
        if (this.connection instanceof Ext.data.Connection) {
            ...
            conn = Ext.create('SinoSoft.ux.upload.data.Connection', {
                disableCaching : true,
                method : this.method,
                url : url,
