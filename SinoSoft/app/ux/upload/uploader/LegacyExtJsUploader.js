 ...
 * 
 */
Ext.define('SinoSoft.ux.upload.uploader.LegacyExtJsUploader', {
    extend: 'SinoSoft.ux.upload.uploader.AbstractUploader',

    requires : [
        'SinoSoft.ux.upload.data.Connection'
    ],
     ...
     * 
     * @return {SinoSoft.ux.upload.data.Connection}
     */
    initConnection : function() {
        ...
        var conn = Ext.create('SinoSoft.ux.upload.data.Connection', {
            disableCaching : true,
            method : this.method,
            url : url,
    ...
    /**
     * Implements {@link SinoSoft.ux.upload.uploader.AbstractUploader#uploadItem}
     * 
     * @param {SinoSoft.ux.upload.Item} item
     */
    ...
    /**
     * Implements {@link SinoSoft.ux.upload.uploader.AbstractUploader#abortUpload}
     */
