 ...
 * 
 * @class SinoSoft.ux.upload.ItemGridPanel
 * @extends Ext.grid.Panel
 */
Ext.define('SinoSoft.ux.upload.ItemGridPanel', {
    extend : 'Ext.grid.Panel',

    requires : [
        'Ext.selection.CheckboxModel', 'SinoSoft.ux.upload.Store'
    ],
    ...
    initComponent : function() {
        ...
        Ext.apply(this, {
            store : Ext.create('SinoSoft.ux.upload.Store'),
