 ...
 * 
 */
Ext.define('SinoSoft.ux.upload.Manager', {
    mixins : {
        observable : 'Ext.util.Observable'
    },

    requires : [
        'SinoSoft.ux.upload.uploader.AbstractUploader'
    ],
    ...
    DEFAULT_UPLOADER_CLASS: 'SinoSoft.ux.upload.uploader.ExtJsUploader',
    ...
    constructor : function(config) {
        ...
        if (!(this.uploader instanceof SinoSoft.ux.upload.uploader.AbstractUploader)) {
