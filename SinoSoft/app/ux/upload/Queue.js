 ...
 * 
 */
Ext.define('SinoSoft.ux.upload.Queue', {
    extend : 'Ext.util.MixedCollection',

    requires : [
        'SinoSoft.ux.upload.Item'
    ],
     ...
     * 
     * @return {SinoSoft.ux.upload.Item[]}
     */
    getItems : function() {
     ...
     * 
     * @return {SinoSoft.ux.upload.Item/null}
     */
     ...
     * 
     * @param {SinoSoft.ux.upload.Item[]} items
     */
    ...
    createItem : function(file) {
        ...
        var item = Ext.create('SinoSoft.ux.upload.Item', {
            fileApiObject : file
        });
