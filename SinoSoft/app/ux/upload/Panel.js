 ...
 * 
 *     @example
 *     var uploadPanel = Ext.create('SinoSoft.ux.upload.Panel', {
 *         uploaderOptions: {
 *             url: '/api/upload'
 *         }
 *     });
 ...
 *     @example
 *     var uploadPanel = Ext.create('SinoSoft.ux.upload.Panel', {
 *         uploader: 'SinoSoft.ux.upload.uploader.FormDataUploader',
 *         uploaderOptions: {
 *             url: '/api/upload',
 *             timeout: 120*1000
 *         }
 ...
 * 
 *     @example
 *     var formDataUploader = Ext.create('SinoSoft.ux.upload.uploader.FormDataUploader', {
 *         url: '/api/upload'
 *     });
 *     
 *     var uploadPanel = Ext.create('SinoSoft.ux.upload.Panel', {
 ...
 * 
 */
Ext.define('SinoSoft.ux.upload.Panel', {
    extend : 'Ext.panel.Panel',

    requires : [
        'SinoSoft.ux.upload.ItemGridPanel',
        'SinoSoft.ux.upload.Manager',
        'SinoSoft.ux.upload.StatusBar',
        'SinoSoft.ux.upload.BrowseButton',
        'SinoSoft.ux.upload.Queue'
    ],
    ...
    config : {
         ...
         * uploader object, for example if the {@link SinoSoft.ux.upload.uploader.ExtJsUploader} is used, the params are sent
         * as GET params.
         */
        uploadParams : {},
        ...
        selectionMessageText : '总文件数{0}, 共{1}',
        uploadMessageText : '已上传进度 {0}% ({1}/{2})',
    ...
    /**
     * @property {SinoSoft.ux.upload.Queue}
     * @private
     */
    queue : null,

    /**
     * @property {SinoSoft.ux.upload.ItemGridPanel}
     * @private
     */
    grid : null,

    /**
     * @property {SinoSoft.ux.upload.Manager}
     * @private
     */
    uploadManager : null,

    /**
     * @property {SinoSoft.ux.upload.StatusBar}
     * @private
     */
    statusBar : null,

    /**
     * @property {SinoSoft.ux.upload.BrowseButton}
     * @private
     */
    browseButton : null,
    ...
    initComponent : function() {
        ...
        this.grid = Ext.create('SinoSoft.ux.upload.ItemGridPanel', {
            queue : this.queue,
        ...
        this.statusBar = Ext.create('SinoSoft.ux.upload.StatusBar', {
            dock : 'bottom',
    ...
    createUploadManager : function() {
        ...
        var uploadManager = Ext.create('SinoSoft.ux.upload.Manager', {
    ...
    getTopToolbarConfig : function() {
        ...
        this.browseButton = Ext.create('SinoSoft.ux.upload.BrowseButton', {
     ...
     * 
     * @return {SinoSoft.ux.upload.Queue}
     */
    initQueue : function() {
        var queue = Ext.create('SinoSoft.ux.upload.Queue');
     ...
     * new files.
     * 
     * @param {SinoSoft.ux.upload.BrowseButton} input
     ...
     * 
     * @param {SinoSoft.ux.upload.Queue} queue
     */
